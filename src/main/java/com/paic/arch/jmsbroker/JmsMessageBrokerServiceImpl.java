...
/**
 * 服务类接口实现
* @create by wei.hu on 2018年2月24日 下午7:36:00
 */
@Service
public class JmsMessageBrokerServiceImpl implements JmsMessageBrokerService{
	...
	public JmsMessageBrokerServiceImpl(JmsMessageBroker jmsBroker) {
	...
	private DestinationStatistics getDestinationStatisticsFor(String aDestinationName) throws Exception {
        ...
        throw new IllegalStateException(String.format("Destination %s does not exist on broker at %s", aDestinationName, jmsBroker.getBrokerUrl()));
    }
